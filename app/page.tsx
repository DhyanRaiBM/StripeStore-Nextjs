...
export default async function page() {
  ...
  return (
    <div className="bg-blue-50 py-8 px-8 min-h-screen">
      <div>
        <div className="py-3 flex flex-col items-center justify-between max-w-4xl mx-auto">
          <h2 className="px-16 font-bold text-xl">
            Product List ({products && products.length})
          </h2>
          <h4><strong>The Products are fetched from the DummyJson API endpoint.</strong></h4>
        </div>
